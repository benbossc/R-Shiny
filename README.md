...
tags$div(style="color:red",
  tags$p("Created by:"),
  tags$a(href = "https://www.nd.edu/", "[Your name], a student at University of Notre Dame")
  )
```
This creates a block of text that is coloured red (```style="color:red"```), within that block there is a paragraph of text (```tags$p("Created by:")```) and a link (```tags$a(href = "https://www.nd.edu/", "[Your name], a student at University of Notre Dame```).
